...
screen main_menu():
    ...
    imagemap:
        ...
        idle "gui/main_menu_title1.png"
        hover "gui/main_menu_title2.png"

        hotspot(35, 130, 240, 70) action Start()
        hotspot(35, 260, 340, 70) action ShowMenu("load")
        hotspot(35, 390, 340, 70) action ShowMenu("preferences")
        hotspot(35, 510, 270, 70) action ShowMenu("about")
        hotspot(35, 960, 200, 70) action Quit(confirm=True)
